...
import com.buka.service.ReportService;
...
public class ReportController {
    ...
    public Result getMemberReport(){
        ...
        try {
            for (int i = 0; i < 12; i++) {
                ...
                counts.add(memberService.countByMonth(new SimpleDateFormat("yyyy.MM").format(calendar.getTime())));
            }
    ...
    public Result exportBusinessReport(HttpServletRequest request, HttpServletResponse response){
        try{
            Map<String,Object> result= reportService.findBusinessReport();
